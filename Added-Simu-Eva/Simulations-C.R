...
save(results_simulationC1, file = "./Added-Simu-Eva/Results-addC-rep2-miscerror.RData")


#######################################
# Plot simulation results
#######################################
load("./Added-Simu-Eva/Results-addC-rep2-miscerror.RData")
png("./Added-Simu-Eva/Figures/Simulation-C-rep2-flipped.png", width = 1200, height = 1500, res = 200)
