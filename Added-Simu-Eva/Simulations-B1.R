...
save(different_scenarios, file = "./Added-Simu-Eva/Results-allmethods-addA-rep2-miscerror-B1.RData")


#######################################
# Plot simulation results
#######################################
load("./Added-Simu-Eva/Results-allmethods-addA-rep2-miscerror-B1.RData")
png("./Added-Simu-Eva/Figures/Simulation-rep2-8scenarios-flipped-B1.png", width = 1200, height = 1500, res = 200)
