...
results_simulation8 <- iterate_parameters(simulationB1_8, parameters_list, param_iter, num_replications)
# Diff B all the same theta
results_simulation9 <- iterate_parameters(simulationB1_9, parameters_list, param_iter, num_replications)
###############################################

# Same B same theta
results_simulation1 <- iterate_parameters(sim_setting = simulationB1_1, parameters_list, param_iter, num_replications)
# Different B same theta
results_simulation2 <- iterate_parameters(sim_setting = simulationB1_2, parameters_list, param_iter, num_replications)

# Diff B diff theta
results_simulation3 <- iterate_parameters(simulationB1_3, parameters_list, param_iter, num_replications)
# Same B different theta
results_simulation4 <- iterate_parameters(simulationB1_4, parameters_list, param_iter, num_replications)
...
results_simulation6 <- iterate_parameters(simulationB1_6, parameters_list, param_iter, num_replications)
# Different B alternating theta
results_simulation7 <- iterate_parameters(simulationB1_7, parameters_list, param_iter, num_replications)
...
save(different_scenarios, file = "./Added-Simu-Eva/Results-allmethods-addA-rep100-miscerror-B1.RData")


#######################################
# Plot simulation results
#######################################
load("./Added-Simu-Eva/Results-allmethods-addA-rep100-miscerror-B1.RData")
png("./Added-Simu-Eva/Figures/Simulation-rep100-8scenarios-flipped-B1.png", width = 1200, height = 1500, res = 200)
