...
save(different_scenarios, file = "./Added-Simu-Eva/Results-allmethods-addA-rep100-miscerror-B3.RData")


#######################################
# Plot simulation results
#######################################
load("./Added-Simu-Eva/Results-allmethods-addA-rep100-miscerror-B3.RData")
png("./Added-Simu-Eva/Figures/Simulation-rep100-8scenarios-flipped-B3.png", width = 1200, height = 1500, res = 200)
